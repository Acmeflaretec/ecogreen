...
function Cart() {
  ...
  // const totalBeforeDiscount = subtotal;
  // const totalAfterDiscount = totalBeforeDiscount - discount + deliveryCharges;
  const lastTotal = salePriceTotal > 200 ? salePriceTotal : salePriceTotal + deliveryCharge;
                        ...
                        <div className="col-md-9">
                          <div className="card-body">
                            <div className="align-items-center mb-3">
                              <h5 className="card-title text-primary mb-0 me-3">{item?.productId?.name}</h5>
                              {item?.size && <span className="bg-success-subtle mb-0 px-3">size:{item?.size}</span>}
                            </div>
