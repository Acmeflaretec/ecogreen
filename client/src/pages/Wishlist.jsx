...
function Wishlist() {
  ...
  const handleAddToCart = async (item) => {
    ...
    try {
      ...
      // console.log('wishlist addtocart',response.);
                    ...
                    <div className="product-card">
                      ...
                      <Link to={`/product?productId=${item?._id}`} className="text-decoration-none">
                        ...
                        <div className="product-info">
                          <h3 className="product-title" style={{ color: 'black' }}>{item.name}</h3>
                          <div className="price-info">
                            <span className="current-price">₹{item.sale_rate}</span>
                            <span className="original-price">₹{item.price}</span>
                            <span className="discount-badge" style={{ backgroundColor: '#4caf50' }}>{item.discount}% off</span>
                          </div>
